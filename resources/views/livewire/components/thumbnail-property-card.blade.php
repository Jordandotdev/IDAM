...
to be used as a template --}}
    <div
        ...
        <div
            ...
            <span class="text-gray-400 font-bold text-xs">{{ $listing->id }}</span>
            <span class="text-gray-800 font-bold text-3xl mb-2">{{ $listing->id }}</span>
            <p class="text-neutral-800">{{ $listing->id }}</p>
        </div>
